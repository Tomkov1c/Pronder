...
public class PageService : IPageService
{
    ...
    public PageService()
    {
        ...
        Configure<ProjectAboutViewModel, ProjectAboutPage>();
        Configure<ProjectToDoViewModel, ProjectToDoPage>();
        Configure<GeneralProjectDisplayViewModel, GeneralProjectDisplayPage>();
        ...
        Configure<SettingsInterfaceViewModel, SettingsInterfacePage>();
    }
