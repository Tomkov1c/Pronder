...
using Pronder.Activation;
using Pronder.Contracts.Services;
using Pronder.Core.Contracts.Services;
using Pronder.Core.Services;
using Pronder.Helpers;
using Pronder.Models;
using Pronder.Services;
...
public partial class App : Application
{
    ...
    public App()
    {
        ...
        ConfigureServices((context, services) =>
        {
            ...
            services.AddTransient<EditProjectPagesGeneralPage>();
            ...
            services.AddTransient<ProjectAboutPage>();
