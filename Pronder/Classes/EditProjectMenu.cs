...
namespace Pronder.Classes
{
    public sealed class EditDataContentDialog : ContentDialog
    {
        ...
        public EditDataContentDialog()
        {
            ...
            string filepath = localSettings.Values["currentlyActiveProject"].ToString();

            Project project = JsonConvert.DeserializeObject<Project>(File.ReadAllText(filepath));
