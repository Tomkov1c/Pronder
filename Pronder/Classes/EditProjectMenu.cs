...
namespace Pronder.Classes
{
    public sealed class EditDataContentDialog : ContentDialog
    {
        ...
        private StackPanel CreateField(string label, string description, string placeholder, string inserteText, string glyphPath)
        {
        ...
        private StackPanel CreateFileField(string label, string description, string buttonText, string previewPath, string glyphPath)
        {
            ...
            if (previewPath != null)
            {
                var filePreview = new StackPanel
                {
                ...
                {
                    Fill = (Brush)Application.Current.Resources["LayerFillColorAltBrush"],
                    HorizontalAlignment = HorizontalAlignment.Stretch,
                    Height = 1,
                    Margin = new Thickness(0, 16, 0, 16),
                };

                var imagePath = new TextBlock
                {
                    Text = "File path: " + previewPath,
                    TextWrapping = TextWrapping.Wrap,
                ...
                var limiter = new Viewbox
                {
                    MaxHeight = 200 - (filePreview.Padding.Top * 2),
                };
                ...
                limiter.Child = image;
                filePreview.Children.Add(limiter);

                filePreview.Children.Add(myRectangle);
                filePreview.Children.Add(imagePath);
                ...
                stack.Children.Add(filePreview);
            }
